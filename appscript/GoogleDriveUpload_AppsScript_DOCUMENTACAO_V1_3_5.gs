 ...
 *
 * V 1.3.5: Web App exclusivo de Documentação. Use este script somente na conta dona do Drive/Pasta de Documentação.
 */

// Pastas raiz oficiais. Cada módulo deve gravar somente na sua própria pasta.
const DOCUMENTACAO_ROOT_FOLDER_ID = '';
const EXPANSOES_ROOT_FOLDER_ID = ''; // não usado neste Web App
...
const ATNX_DRIVE_MODULE = 'documentacao';
