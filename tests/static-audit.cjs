...
assert(app.includes("window.__ATLAS_VERSION__ = '2.3.0 OFICIAL'"), 'Versao interna divergente.');
assert(config.includes('V2.3.0 Oficial'), 'Config sem a versao do pacote.');
...
assert(manifest.includes('2.3.0'), 'Manifest sem a versao do pacote.');
...
console.log('Atlas V2.3.0: auditoria estatica aprovada.');
